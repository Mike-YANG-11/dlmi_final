...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes, block, layers):
        ...
        self.clsHead = ClassificationHead(256, num_classes=num_classes)

        self.anchors = Anchors()

        self.regBoxes = BBoxTransform()
        ...
        self.clsHead.output.weight.data.fill_(0)
        self.clsHead.output.bias.data.fill_(-math.log((1.0 - prior) / prior))
    ...
    def forward(self, inputs):
        ...
        if self.training:
            ...
            transformed_anchors = self.regBoxes(anchors, regression)
